<template>
  ...
  >
    <defs>
      <linearGradient :id="linear_id" y1="0.5" x2="1" y2="0.5" gradientUnits="objectBoundingBox">
        <stop offset="0" stop-color="#ae865d" />
        <stop offset="1" stop-color="#e9c18d" />
      </linearGradient>
    </defs>
    <g id="logo2" transform="translate(-86.181 -905.499)">
      <g id="Group_25" data-name="Group 25" transform="translate(231.604 929.918)">
        <g id="Group_23" data-name="Group 23" transform="translate(0 0)">
          <path
            id="Path_49"
            data-name="Path 49"
            d="M391.748,987.506h-12.4c.981-2.134.923-2.711.923-5.019v-21a10.647,10.647,0,0,0-.808-5.018H392.5c6.288,0,13.383,2.711,16.209,10.325C412.341,976.43,404.553,987.506,391.748,987.506Zm-6.287-28.842v26.708h6c10.9,0,12.633-8.134,12.46-13.267-.174-5.192-3.923-13.441-13.325-13.441Z"
            transform="translate(-379.346 -955.606)"
            fill="#ede7df"
          />
          <path
            id="Path_50"
            data-name="Path 50"
            d="M462.826,987.153l-4.846-11.364H447.829l-4.788,11.364H439.81a17.059,17.059,0,0,0,2.711-4.673l11.306-26.823h1.212l11.133,26.13c1.1,2.6,1.673,2.942,3.807,5.365ZM452.9,963.907l-3.922,9.229h7.845Z"
            transform="translate(-409.817 -955.196)"
            fill="#ede7df"
          />
          <path
            id="Path_51"
            data-name="Path 51"
            d="M531,958.88v28.669h-1.384L507.464,963.38V983.4a8.628,8.628,0,0,0,.576,3.288H504.7a8.621,8.621,0,0,0,.577-3.288V954.727h1.269l22.208,24.17V958.88a8.619,8.619,0,0,0-.577-3.288h3.4A8.618,8.618,0,0,0,531,958.88Z"
            transform="translate(-442.516 -954.727)"
            fill="#ede7df"
          />
          <path
            id="Path_52"
            data-name="Path 52"
            d="M570.392,987.506a10.949,10.949,0,0,0,.923-5.019v-21a10.947,10.947,0,0,0-.923-5.018h7.037a10.236,10.236,0,0,0-.923,5.018v21a10.238,10.238,0,0,0,.923,5.019Z"
            transform="translate(-475.625 -955.606)"
            fill="#ede7df"
          />
          <path
            id="Path_53"
            data-name="Path 53"
            d="M613.152,987.506H594.693c.981-2.134.923-2.711.923-5.019v-21a10.235,10.235,0,0,0-.923-5.018H612.46l1.558,3.518c-3.692-1.384-4.269-1.327-5.538-1.327h-7.672V968.3h11.075l-.75,2.192H600.808v14.882h8.364c1.212,0,1.9-.231,5.25-1.558Z"
            transform="translate(-487.871 -955.606)"
            fill="#ede7df"
          />
          <path
            id="Path_54"
            data-name="Path 54"
            d="M659.664,987.506H641.2c.981-2.134.923-2.711.923-5.019v-21a10.229,10.229,0,0,0-.923-5.018h7.037a10.239,10.239,0,0,0-.923,5.018v23.881h8.364c1.212,0,1.9-.231,5.25-1.558Z"
            transform="translate(-511.311 -955.606)"
            fill="#ede7df"
          />
        </g>
        <g id="Group_24" data-name="Group 24" transform="translate(0 41.338)">
          <path
            id="Path_55"
            data-name="Path 55"
            d="M400.343,1070.039a10.238,10.238,0,0,0,.923-5.019v-12.4h-15.8v12.4a10.237,10.237,0,0,0,.923,5.019h-7.037a10.237,10.237,0,0,0,.923-5.019v-21a10.233,10.233,0,0,0-.923-5.018h7.037a10.234,10.234,0,0,0-.923,5.018v6.345h15.8v-6.345a10.235,10.235,0,0,0-.923-5.018h7.038a10.235,10.235,0,0,0-.923,5.018v21a10.239,10.239,0,0,0,.923,5.019Z"
            transform="translate(-379.346 -1038.537)"
            fill="#ede7df"
          />
          <path
            id="Path_56"
            data-name="Path 56"
            d="M460.658,1070.266c-6.287.057-13.5-2.711-16.382-10.383-3.576-9.634,4.269-21.054,16.325-21.113,6.287-.057,13.555,2.769,16.382,10.326C480.616,1058.73,472.6,1070.209,460.658,1070.266Zm-.058-28.957c-8.826-.057-11.941,7.787-11.595,12.979.577,8.826,7.441,13.613,11.595,13.555,9.114-.173,11.883-7.9,11.537-13.152C471.56,1045.924,464.753,1041.309,460.6,1041.309Z"
            transform="translate(-411.629 -1038.419)"
            fill="#ede7df"
          />
          <path
            id="Path_57"
            data-name="Path 57"
            d="M547.483,1069.57a16.446,16.446,0,0,0,.116-5.6l-2.019-15.748-10.614,21.343h-1.327l-10.383-21-1.961,15.748a20.393,20.393,0,0,0-.058,5.307h-3.518a14.641,14.641,0,0,0,1.326-5.134l3.288-26.419h1.673l11.94,24.227,12-24.227H549.5l3.461,26.361a14.643,14.643,0,0,0,1.326,5.134Z"
            transform="translate(-449.079 -1038.068)"
            fill="#ede7df"
          />
          <path
            id="Path_58"
            data-name="Path 58"
            d="M617.573,1070.039H599.114c.98-2.135.923-2.711.923-5.019v-21a10.24,10.24,0,0,0-.923-5.018h17.767l1.557,3.518c-3.692-1.385-4.268-1.326-5.538-1.326h-7.672v9.633H616.3l-.75,2.192H605.228V1067.9h8.364c1.211,0,1.9-.23,5.249-1.557Z"
            transform="translate(-490.099 -1038.537)"
            fill="#ede7df"
          />
          <path
            id="Path_59"
            data-name="Path 59"
            d="M652.455,1069.967c-3-.057-5.365-.346-10.441-3.288l-.692-5.019s5.538,6.057,11.248,6.345c2.711.115,6.115-1.442,6.692-4.672.634-3.692-1.1-5.365-6.749-8.249-5.538-2.885-10.9-5.25-10.095-10.441.462-2.884,4.384-6.518,10.556-6.575,2.25-.058,5.134.23,9.634,2.423l.461,4.1c-4.673-4.441-8.768-4.845-10.614-4.5-4.9.98-7.787,5.595,1.961,10.325,6.922,3.346,11.479,5.826,10.268,12.575C663.877,1067.372,657.7,1070.083,652.455,1069.967Z"
            transform="translate(-511.37 -1038.062)"
            fill="#ede7df"
          />
        </g>
      </g>
      <g id="Group_26" data-name="Group 26" transform="translate(86.181 905.499)">
        <path
          id="Path_60"
          data-name="Path 60"
